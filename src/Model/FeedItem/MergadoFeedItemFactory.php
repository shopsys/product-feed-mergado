...
class MergadoFeedItemFactory
{
    ...
    public function createForProduct(Product $product, DomainConfig $domainConfig): MergadoFeedItem
    {
        ...
        return new MergadoFeedItem(
            $product->getId(),
            $product->getCatnum(),
            $product->getName($domainConfig->getLocale()), // TODO extend in project-base
            ...
            $this->availabilityFacade->getProductAvailabilityDaysByDomainId($product, $domainId) ?? 0, // TODO
     ...
     * @return string
     */
    protected function mapStockStatusToAvailability(string $availabilityStatus): string
    {
